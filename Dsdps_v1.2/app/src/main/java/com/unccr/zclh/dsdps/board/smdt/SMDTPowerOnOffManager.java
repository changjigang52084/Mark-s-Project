package com.unccr.zclh.dsdps.board.smdt;
...
public class SMDTPowerOnOffManager {
    private static final String TAG = "SMDTPowerOnOffManager";
...
//        Log.d(TAG, "cancelPowerOnOff cancelPowerOnOff");
...
//        if (fd < 0) {
//            if (3 == enable) {
//                Log.d(TAG, "setPowerOnOff 开启定时开关机-打开节点失败");
//            } else if (0 == enable) {
//                Log.d(TAG, "setPowerOnOff 取消定时开关机-打开节点失败");
//            }
//        } else {
//            ret = posix.poweronoff(off_h, off_m, on_h, on_m, enable, fd);
//            if (ret != 0) {
//                if (3 == enable) {
//                    Log.d(TAG, "setPowerOnOff 开启定时开关机-设置命令失败！");
//                } else if (0 == enable) {
//                    Log.d(TAG, "setPowerOnOff 关闭定时开关机-设置命令失败！");
//                }
//            } else {
//                isSuccess = true;
//                if (3 == enable) {
//                    // mOnh, mOnm, mOffh, mOffm;
//                    Log.d(TAG, "setPowerOnOff 定时开关机：开。"
//                            + on_h + "小时"
//                            + on_m + "分钟 后系统自动关机；"
//                            + off_h + "小时"
//                            + off_m + "分钟 后系统自动开机。");
//                } else if (0 == enable) {
//
//                    Log.d(TAG, "setPowerOnOff 定时开关机：关。");
//                }
//            }
//        }
//        posix.close(fd);
