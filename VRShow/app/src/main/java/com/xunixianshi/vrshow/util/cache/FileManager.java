...
public class FileManager {
  ...
  public void writeBitmapToFile(File file,Bitmap bitmap){
  ...
  public void writeCacheToFile(File file,Cache cache){
    if(cache.getCacheType()== CacheType.IMAGE){
      writeBitmapToFile(file,cache.getBitmap());
    }
    else if(cache.getCacheType() == CacheType.JSON){
      writeToFile(file,cache.getJson());
    }
  }
