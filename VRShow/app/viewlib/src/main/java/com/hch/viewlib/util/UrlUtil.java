...
public class UrlUtil {
    ...
    public static boolean isEncoded(String content, String charset) {
        ...
        MLog.d("wlf", "isEncoded，check content" + content);
    ...
    public static String getEncodedUrl(String url, String charset, boolean useFragment, boolean blankAsPlus) {
    	...
    	MLog.d("url","getEncodedUrl--------------------");

    	MLog.d("url","getEncodedUrl，准备编码URL，url" + url);
        ...
        try {
            ...
            MLog.d("url","getEncodedUrl，开始编码URL，unEncodeUrl" + unEncodeUrl);

            MLog.d("url","getEncodedUrl，开始编码URL，getProtocol" + unEncodeUrl.getProtocol());

            MLog.d("url","getEncodedUrl，开始编码URL，getHost" + unEncodeUrl.getHost());
            MLog.d("url","getEncodedUrl，开始编码URL，getUserInfo" + unEncodeUrl.getUserInfo());

            MLog.d("url","getEncodedUrl，开始编码URL，getPort" + unEncodeUrl.getPort());

            MLog.d("url","getEncodedUrl，开始编码URL，getFile" + unEncodeUrl.getFile());
            MLog.d("url","getEncodedUrl，开始编码URL，getPath" + unEncodeUrl.getPath());
            MLog.d("url","getEncodedUrl，开始编码URL，getQuery" + unEncodeUrl.getQuery());
            MLog.d("url","getEncodedUrl，开始编码URL，getRef" + unEncodeUrl.getRef());
        ...
        MLog.e("url","getEncodedUrl，编码后URL，encodedUrl" + encodedUrl);
