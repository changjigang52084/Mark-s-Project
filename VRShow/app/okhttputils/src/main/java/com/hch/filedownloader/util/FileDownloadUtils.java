...
/**
 * Created by duanchunlin on 9/25/15.
 */
...
//                .getExternalStorageDirectory().toString());
     ...
     * {@link com.hch.filedownloader.BaseDownloadTask#setPath(String)}
     *
...
//    }
    ...
    public static String getStack(final StackTraceElement[] stackTrace, final boolean printLine) {
        ...
        for (int i = 3; i < stackTrace.length; i++) {
            if (!stackTrace[i].getClassName().contains("com.hch.filedownloader")) {
                continue;
            }
            t.append("[");
            t.append(stackTrace[i].getClassName().substring("com.hch.filedownloader".length()));
            t.append(":");
