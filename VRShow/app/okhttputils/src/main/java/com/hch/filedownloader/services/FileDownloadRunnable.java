...
//    private long lastNotifiedSoFar = 0;  //原来按百分比
    private long lastNotifiedSoFar = 0;  //修改为时间戳
...
//        }
        ...
        if(currentTimeMillis - lastNotifiedSoFar <= 500){ //改为按时间频率来通知更新消息
            return;
        }
        lastNotifiedSoFar =  currentTimeMillis;
